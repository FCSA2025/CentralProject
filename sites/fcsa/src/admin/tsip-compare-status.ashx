<%@ WebHandler Language="C#" Class="TsipCompareStatusHandler" %>
...
/// <summary>
/// Same-origin FCSA admin: poll job status for a TSIP compare started via tsip-compare-start.ashx.
/// </summary>
public class TsipCompareStatusHandler : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            // Read with share so the worker can rewrite while we poll.
            string json;
            ...
            // Ensure status field is present for the UI.
