...
| `source/mics/Ttsipmenu/TwsTsip.asmx` (+ `.cs`) | `...\Ttsipmenu\...` | Live **symlink →** repo (optional) | **Gate A — tracked** |
| `source/mics/Tfileactions/copy.aspx` (+ `.cs`) | `...\Tfileactions\...` | Live **symlink →** repo (optional) | **Gate A — tracked** |
